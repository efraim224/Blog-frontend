  ...
  return (
    ...
    <Card sx={{ maxWidth: 345 }}>
      ...
      <CardContent>
        ...
        <Box height="320px">
          <Typography sx={{ marginTop: 2, marginBottom: 2 }} gutterBottom variant="h6" component="div" >
            <b>{props.title.length > 56 ? props.title.slice(0, 56) + "..." : props.title}</b>
          </Typography>
          <Author name={props.name} created_at={props.created_at} />
